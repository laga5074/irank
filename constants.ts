...
// It is now hardcoded to the correct value for the bounty submission.
export const KICK_REDIRECT_URI = process.env.REACT_APP_REDIRECT_URI || 'https://kick-autohoster.netlify.app/callback';
